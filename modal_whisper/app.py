"""
Modal app: Whisper Quran int8 — HTTP API for Quran transcription.
...
app = modal.App("whisper-quran-int8")
...
def web():
    ...
    api = FastAPI(
        title="Whisper Quran int8",
        description="Transcribe Quran recitation audio (WAV) to Arabic text. Model: wasimlhr/whisper-quran-v1-int8",
    )
