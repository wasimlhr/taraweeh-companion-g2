"""
Whisper Quran int4 inference handler for Modal.
Loads wasimlhr/whisper-quran-v1-int4 and transcribes WAV audio to Arabic text with optional word-level timestamps.
"""
...
# Model ID on HuggingFace (quantized int4)
MODEL_ID = "wasimlhr/whisper-quran-v1-int4"
LANGUAGE = "ar"
TASK = "transcribe"
...
def get_model_card() -> dict:
    ...
    return {
        "model": MODEL_ID,
        "description": "Whisper Large V3 fine-tuned for Quran recitation (int4 quantized)",
        "language": LANGUAGE,
        "task": TASK,
        "quantization": "int4",
