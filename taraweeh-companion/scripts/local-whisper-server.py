...
Accepts the same thing groqProvider sends — a multipart WAV upload — and answers with text
    ...
    def do_POST(self):
        ...
        try:
            ...
            with INFER_LOCK:
                ...
                # faster-whisper decodes lazily while this generator is consumed.
                # Hold the lock through iteration, not just generator creation.
                words, texts = [], []
                for seg in segments:
